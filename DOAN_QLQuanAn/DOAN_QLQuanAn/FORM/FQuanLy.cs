...
namespace DOAN_QLQuanAn
{
    public partial class FQuanLy : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'doAn_QLTechCenterFoodDataSet1.USP_GetListBillByDate' table. You can move, or remove it, as needed.
            //this.usP_GetListBillByDateTableAdapter.Fill(this.doAn_QLTechCenterFoodDataSet1.USP_GetListBillByDate);
            // TODO: This line of code loads data into the 'doAn_QLTechCenterFoodDataSet2.USP_GetTableList' table. You can move, or remove it, as needed.
            this.uSP_GetTableListTableAdapter.Fill(this.doAn_QLTechCenterFoodDataSet2.USP_GetTableList);
            /*
            //Report Thực đơn
        ...
        private void btThanhToan_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (idBill != -1)
                {
                    ...
                    {
                        ReportHoaDon rp = new ReportHoaDon(discount);
                        rp.ShowDialog();
                    }
        ...
        private void rpTaiKhoan_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    //string ten = txtrpUser.Text;

                    accountTableAdapter.Fill(this.doAn_QLTechCenterFoodDataSet.Account, txtrpUser.Text, i);
                    this.reportTaiKhoan.RefreshReport();
                }
            }
            catch { }
        ...
        {
            this.usP_GetListBillByDateTableAdapter.Fill(this.doAn_QLTechCenterFoodDataSet1.USP_GetListBillByDate, dateFromDate.Value, dateToDate.Value); 
